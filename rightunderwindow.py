...
class RightUnderWindow(QWidget):
    ...
    def __init__(self, baze, parent=None):
        ...
        elif self.baze == Работа:
            self.add_clickable_widget(f'Создать заявку на уборку', 15)
        elif self.baze == Сотрудники:
            self.add_clickable_widget(f'Добавить сотрудника', 16)
        elif self.baze == Виды_работ:
            self.add_clickable_widget(f'Добавить вид работы', 17)
